...
- (void)viewDidLoad
{
    ...
    if (_canuError == CANUErrorNoInternetConnection) {
        ...
        self.illustration.frame = CGRectMake((320 - 85)/2, (self.view.frame.size.height - 480)/3 + 30, 85, 196);
        self.descriptionError.text = NSLocalizedString(@"Would you like to be notified \n\nwhen your friends invite you ?", nil);
        self.descriptionError.frame = CGRectMake(30, (self.view.frame.size.height - 480)/2 + 240, 260, 210);
    }
